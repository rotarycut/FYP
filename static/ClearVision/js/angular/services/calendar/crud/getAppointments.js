angular.module('appointment.service', [])
    ...
    .service('appointmentService', function ($http, $q, $timeout, $log) {
        ...
        this.getDoctorAppointments = function (doctor, appointmentTypeArray) {

            var promises = [];

            angular.forEach(appointmentTypeArray, function (appointmentType) {

                promises.push($http.get('/Clearvision/_api/appointments/?doctor__name=' + doctor + '&apptType=' + appointmentType)
